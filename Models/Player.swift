...
class Player: NSObject, ObservableObject, AVAudioPlayerDelegate {
    ...
    @Published var bookName: String = "The Founder Factor in Startups"
    @Published var trackName: String = "The Founder Factor" //The Founder Factor.mp3
    @Published var authorName: String = "Truitt Nancy Pierce"
