...
class AutoCarouselViewModel<Data, ID>: ObservableObject where Data : RandomAccessCollection, ID : Hashable {
    /// external index
    @Binding
    ...
    private let _autoScroll: AutoCarouselAutoScroll
    private let _canMove: Bool
    
    init(_ data: Data, id: KeyPath<Data.Element, ID>, index: Binding<Int>, spacing: CGFloat, headspace: CGFloat, sidesScaling: CGFloat, isWrap: Bool, autoScroll: AutoCarouselAutoScroll, canMove: Bool) {
...
extension AutoCarouselViewModel where ID == Data.Element.ID, Data.Element : Identifiable {
    convenience init(_ data: Data, index: Binding<Int>, spacing: CGFloat, headspace: CGFloat, sidesScaling: CGFloat, isWrap: Bool, autoScroll: AutoCarouselAutoScroll, canMove: Bool) {
...
extension AutoCarouselViewModel {
    var data: Data {
    ...
    var timer: AutoCarouselTimePublisher? {
...
extension AutoCarouselViewModel {
    ...
    private var autoScroll: AutoCarouselAutoScroll {
